...
"Friendlyname,RecoveryVMName,srcIP,dstIP,srcSubnet,dstSubnet,srcIPtype,dstUPtype,srcSize,dstSize,Policy,dstPIP,dstNSG,dstLBBEP,srcAS,dstAS"| out-file c:\temp\replitemsconfig.csv
