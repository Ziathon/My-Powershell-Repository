...
Modified:
v1.1 - Theron Howton - 10/14/2019
    - Added Schema version check for Server 2019
...
# Schema version
    ...
    $sVersion = $schema.objectVersion
        If ($schema.objectVersion -eq 47) { Write-Host "Schemea Version:" -NoNewline; Write-Host " 47 - Server 2008 R2" -ForegroundColor Yellow }
            ...
            ElseIf ($schema.objectVersion -eq 88) { Write-Host "Schemea Version:" -NoNewline; Write-Host "  88 - Server 2019" -ForegroundColor Green }
